...
use src\Hemarao\LaravelCdn\Exceptions\MissingConfigurationException;
use src\Hemarao\LaravelCdn\Exceptions\UnsupportedProviderException;
...
{
    public const DRIVERS_NAMESPACE = 'Hemarao\\LaravelCdn\\Providers\\';
